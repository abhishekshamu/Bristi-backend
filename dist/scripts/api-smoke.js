...
async function main() {
    ...
    const { run: runSeed } = await Promise.resolve().then(() => __importStar(require('./seed')));
    await runSeed();
    const { run: runContentSeed } = await Promise.resolve().then(() => __importStar(require('./seed-content')));
